    ...
    def handle(self, *args, **kwargs):
        try:
            with transaction.atomic():
                ...
                Category.objects.create(pk=1, name="Сухие корма", description="Описание категории Сухие корма.")
                Category.objects.create(pk=2, name="Влажные корма", description="Описание категории Влажные корма.")
